package com.wzt.restfulapi.system.controller;

import com.wzt.restfulapi.security.entity.CurrentUser;
...
public class UserController {
    ...
    public ResponseEntity<User> deleteUserByUserName(@RequestParam("username") String username){
